## threemxl (indigo) - 0.2.0-2

The packages in the `threemxl` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo threemxl` on `Thu, 03 Jul 2014 14:49:22 -0000`
...
User `wcaarls@TUD419056` released the packages in the `threemxl` repository by running `/usr/bin/bloom-release --rosdistro hydro --track hydro threemxl` on `Mon, 13 Jan 2014 10:47:13 -0000`
...
User `wcaarls@TUD419056` released the packages in the `threemxl` repository by running `/usr/bin/bloom-release --rosdistro hydro --track hydro threemxl` on `Wed, 09 Oct 2013 13:50:59 -0000`
